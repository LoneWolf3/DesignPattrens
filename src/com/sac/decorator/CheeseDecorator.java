...
/**
 * * A Decorator class, which adds cheese (new functionality) into Sandwich
 * object. * This Decorator class modifies price() and getDescritption() method
 * to implement * new behaviour. * * @author
 */
